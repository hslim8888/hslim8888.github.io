var store = [{
        ...
        "excerpt":"환경 구성 docker 이미지 도커 이미지는 flask와 gunicorn 이 같이 설치된 것과, nginx 가 설치된 것 두 개를 만들어 준다. 하나를 만들어서 컨테이너를 두 개 따로 띄워도 되는데, 개별로 만들면 docker-compose로 한 번에 올리기가 편하다. flask &amp; gunicorn 용 아래에도 설명하겠지만, 구동 측면에서 gunicorn은 flask를 대신 실행시켜주는 거라 생각하면 된다....","categories": ["datascience"],
        "tags": ["deeplearning, requests, http, web_server, 속도, 개선"],
